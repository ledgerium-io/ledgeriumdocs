# **Ledgerium Blockchain Core**

Ledgerium Blockchain is using **Geth** as core blockchain client and configured it as per Geth's whitepaper requirements. Ledgerium Blockchain is inspired from J.P. Morgan's Quorum Protocol (Based on the Etherum Foundation's Ethereum Protocol) and utilizes
IBFT (Istanbul Byzantine Fault Tolerant) consensus mechanism for both testnets and mainnet implementations. We aim to keep the source as close to the original ethereum and quorum code as possible.

## **Ledgerium Core**

- Is the official Golang implementation of the Ledgerium protocol.
...
Please read the installation instructions and prerequisits on the wiki.
**Wiki installation link missing**
